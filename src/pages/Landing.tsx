...
export default function Landing() {
  ...
  return (
    <div
      className={`flex min-h-dvh items-end justify-center overflow-hidden bg-white px-4 pb-10 text-black sm:px-6 sm:pb-14 ${
        exiting ? 'opacity-0' : 'opacity-100'
      } transition-opacity duration-300`}
    >
      <div className="flex w-full max-w-6xl flex-col items-center gap-4 lg:flex-row lg:items-end lg:justify-center lg:gap-0">
        <motion.img
          src={landingGif}
