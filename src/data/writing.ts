...
export const writingColumns: WritingColumn[] = [
  {
    ...
    entries: [
      entry(
        { year: 2026, title: 'holding the model', kind: 'essay' },
      ...
      entry(
        { year: 2026, title: 'interfaces that argue back', kind: 'essay' },
      ...
      entry(
        { year: 2025, title: 'trust later, steer first', kind: 'essay' },
      ...
      entry(
        { year: 2025, title: 'small surfaces, loud questions', kind: 'essay' },
      ...
      entry(
        { year: 2025, title: 'the seam as a feature', kind: 'essay' },
      ...
      entry(
        { year: 2024, title: 'when a button is a promise', kind: 'essay' },
      ...
      entry(
        { year: 2024, title: 'attention as scarce material', kind: 'essay' },
      ...
      entry(
        { year: 2024, title: 'prototypes before polish', kind: 'essay' },
      ...
      entry(
        { year: 2023, title: 'systems that still surprise', kind: 'essay' },
      ...
      entry(
        { year: 2023, title: 'designing recovery paths', kind: 'essay' },
      ...
      entry(
        { year: 2023, title: 'type as architecture', kind: 'essay' },
      ...
      entry(
        { year: 2022, title: 'the portfolio as instrument', kind: 'essay' },
      ...
      entry(
        { year: 2021, title: 'legibility at the edge', kind: 'essay' },
      ...
      entry(
        { year: 2021, title: 'craft under constraint', kind: 'essay' },
  ...
  },
  {
    ...
    entries: [
      entry(
        { year: 2026, title: 'lab note: cursor magnets', kind: 'field note' },
  ...
  },
  {
    ...
    entries: [
      entry(
        { year: 2026, title: 'building intentional experiences', kind: 'talk' },
